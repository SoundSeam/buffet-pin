...
const child = spawn(process.execPath, ["node_modules/next/dist/bin/next", "dev", "-p", "3111"], {
  env: {
    ...
    DATABASE_URL: "postgresql://reservation_test@127.0.0.1:55459/reservation_switch_test",
    DIRECT_URL: "postgresql://reservation_test@127.0.0.1:55459/reservation_switch_test",
